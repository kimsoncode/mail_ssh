				...
				<div class="am-tabs" id="doc-my-tabs">
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-active">
							<form id="emailForm">
								...
								<div class="user-pass">
									...
									<input type="password" name="confirPasword" id="passwordRepeat"
										placeholder="确认密码">
								</div>
								...
								<div class="user-pass">
									...
									<input type="text" name="validateCode" id="validateCode"
										style="width: 150px; float: left;" placeholder="验证码">
									<img id="codeImg" alt="验证码" width="170px" height="40px" />
								</div>
							</form>
							...
							<div class="am-cf">
								<input type="submit" id="0" name="" value="注册"
						...
						<div class="am-tab-panel">
							...
							<div class="am-cf">
								<input type="submit" id="1" name="" value="注册"
									class="am-btn am-btn-primary am-btn-sm am-fl">
							</div>
